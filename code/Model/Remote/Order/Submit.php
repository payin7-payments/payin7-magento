        ...
        if ($addresses) {
            foreach ($addresses as $address) {
                $address_data = array_filter(array(
                    ...
                    'telephone3' => '',
                    'fax' => $address->getFax(),
                    'vat_number' => $address->getData('customer_taxvat')/** TODO: Validate this! */
                ));
                $data[] = $address_data;
                unset($address);
            }
        ...
        if ($items) {
            foreach ($items as $item) {
                ...
                $item_data = array_filter(array(
                    ...
                    'details' => $product->getData('short_description')/** TODO: Validate this! */,
                    'details_full' => $product->getData('description')/** TODO: Validate this! */,
